...
grep -l "pattern" *.txt             # show matching filenames
...
grep -E "p1|p2" file.txt            # extended regex (or use egrep)
zgrep "pattern" file.gz             # search inside gzipped file
```
...
## ⚖️ 4. System Monitoring & Performance
